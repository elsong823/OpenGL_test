...
void InitObject()
{
	...
	//初始化一个镜子效果的模型
	model_1 = new CMyModel("../bin/res/nanosuit.obj", texSkybox);
	model_1->SetScale(glm::vec3(0.2f));
	...
	boxReflectShaderProgram = CMyShader::GetInstance()->CreateShaderProgram("../bin/shaders/reflectBox.vert", "../bin/shaders/reflectBox.frag");
	boxRefractShaderProgram = CMyShader::GetInstance()->CreateShaderProgram("../bin/shaders/reflectBox.vert", "../bin/shaders/refractBox.frag");
...
void DrawSkyBox()
{
	...
	//glUniformMatrix4fv(glGetUniformLocation(skyboxShaderProgram, "matView"), 1, GL_FALSE, glm::value_ptr(*camera->GetView()));
